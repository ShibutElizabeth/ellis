...
export default class SkillsController
{
    ...
    // {
    //     this.camControls = {};
    //     this.camControls.toTvScreen = async (pos) =>
    //     {
    //         this.logic.lockButtons(1500);
    //         this.camera.camAngle.unlocked();
    //         this.camera.transitions.tvScreen(1.5, pos);
    ...
    setProjectControls()
    {
        ...
        {
            if(this.logic.buttonsLocked === false && this.logic.mode === 'plant')
            {
    ...
    //     this.plantControls.plantFocus = async () =>
    //     {
    //         if(this.logic.buttonsLocked === false && (this.logic.mode === 'room'))
    //         {
    //             this.logic.mode = 'plant'
    ...
    //     }
        ...
        // {
        //     if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'room'))
        //     {
        //         this.sounds.playBloop()
        ...
        // this.aboutMeControls.aboutMeRoom = async () =>
        // {
        //     if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills'))
        //     {
        //         this.sounds.playBloop()
        //         this.logic.mode = 'room'

        //         if(this.config.vertical === true)
        //         {
        //             this.bigScreenTransition(
        //                 this.materials.bigScreenMaterial,
        //                 this.resources.items.bigScreenRoomMobileTexture,
        //                 0.2
        //             )
        //         }
        //         else
        ...
        //             this.bigScreenTransition(
        //                 this.materials.bigScreenMaterial,
        //                 this.resources.items.bigScreenRoomTexture,
        //                 0.2
        //             )
        //         }
        //     }
    ...
    //     {
    //         if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills' || this.logic.mode === 'room'))
    //         {
    //             this.sounds.playBloop()
    //             this.logic.mode = 'menu'
    //             this.camControls.toDefault()
